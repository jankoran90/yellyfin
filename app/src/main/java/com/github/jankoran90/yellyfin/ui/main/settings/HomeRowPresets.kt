...
fun HomeRowPresetsContent(
    ...
    val presets =
        listOf(
            stringResource(R.string.display_preset_default) to HomeRowPresets.YellyfinDefault,
            stringResource(R.string.display_preset_compact) to HomeRowPresets.YellyfinCompact,
