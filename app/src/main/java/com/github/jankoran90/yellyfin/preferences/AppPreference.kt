...
import com.github.jankoran90.yellyfin.ui.preferences.ConditionalPreferences
import com.github.jankoran90.yellyfin.ui.preferences.PreferenceGroup
import com.github.jankoran90.yellyfin.ui.preferences.PreferenceScreenOption
import com.github.jankoran90.yellyfin.ui.preferences.PreferenceValidation
    ...
    companion object {
        val SkipForward =
            AppSliderPreference<AppPreferences>(
                ...
                summarizer = { value ->
                    if (value != null) {
                        YellyfinApplication.instance.resources.getQuantityString(
                            R.plurals.seconds,
                            value.toInt(),
                            value.toInt(),
                        )
        ...
        val ControllerTimeout =
            AppSliderPreference<AppPreferences>(
                ...
                summarizer = { value ->
                    value?.let {
                        YellyfinApplication.instance.getString(
            ...
            AppSliderPreference<AppPreferences>(
                ...
                summarizer = { value ->
                    if (value != null) {
                        ...
                        if (v == -1) {
                            YellyfinApplication.instance.getString(R.string.no_limit)
                        } else {
                            YellyfinApplication.instance.resources.getQuantityString(
                                R.plurals.days,
                                v,
        ...
        val SkipBackOnResume =
            AppSliderPreference<AppPreferences>(
                ...
                summarizer = { value ->
                    if (value == 0L) {
                        YellyfinApplication.instance.getString(R.string.disabled)
                    } else {
                        "${value}s"
                    }
                },
            ...
            AppSliderPreference<AppPreferences>(
                ...
                summarizer = { value ->
                    if (value == null) {
                        ...
                        YellyfinApplication.instance.getString(R.string.immediate)
                    } else {
                        YellyfinApplication.instance.resources.getQuantityString(
                            R.plurals.seconds,
                            value.toInt(),
        ...
        val UpdateUrl =
            AppStringPreference<AppPreferences>(
                ...
                defaultValue = "https://api.github.com/repos/jankoran90/Yellyfin/releases/latest",
                getter = { it.updateUrl },
                setter = { prefs, value ->
        ...
        val SendCrashReports =
            AppSwitchPreference<AppPreferences>(
                ...
                getter = {
                    PreferenceManager
                        .getDefaultSharedPreferences(YellyfinApplication.instance)
            ...
            AppSliderPreference<AppPreferences>(
                ...
                summarizer = { value ->
                    if (value != null) {
                        ...
                        YellyfinApplication.instance.resources.getString(
                            R.string.decimal_seconds,
                            seconds,
                        )
                    } else {
            ...
            PreferenceGroup(
                ...
                preferences =
                    listOf(
                        ...
                        // Temporarily disabled, see https://github.com/jankoran90/Yellyfin/pull/127#issuecomment-3478058418
