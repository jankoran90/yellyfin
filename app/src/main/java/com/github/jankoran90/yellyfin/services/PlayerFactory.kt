...
import com.github.jankoran90.yellyfin.preferences.MediaExtensionStatus
import com.github.jankoran90.yellyfin.preferences.PlaybackPreferences
    ...
    constructor(
                ...
                when (backend) {
                    ...
                    -> {
                        ...
                        var renderersFactory: RenderersFactory =
                            YellyfinRenderersFactory(context, decodeAv1)
        ...
        fun createAudioPlayer(extensions: MediaExtensionStatus = MediaExtensionStatus.MES_FALLBACK): ExoPlayer {
            ...
            val renderersFactory: RenderersFactory =
                YellyfinRenderersFactory(context, false)
                    .setEnableDecoderFallback(true)
                    .setExtensionRendererMode(rendererMode)
            val mediaSourceFactory =
                DefaultMediaSourceFactory(
...
class YellyfinRenderersFactory(
    context: Context,
